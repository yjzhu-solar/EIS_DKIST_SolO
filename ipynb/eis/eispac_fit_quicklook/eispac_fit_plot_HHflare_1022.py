...
file_dirs = ["../../../src/EIS/HH_Flare/20221022T0808/","../../../src/EIS/HH_Flare/20221022T1118/","../../../src/EIS/HH_Flare/20221022T1834/"]
...
for ii, file_dir in enumerate(file_dirs):
    ...
    for jj, fitres_file in enumerate(fitres_files[:]):
        eispac_fit_plot(fitres_file,save_dir="../../../figs/EIS/quicklook_videos/HH_flare/20221022/",index=jj)