...
if __name__ == '__main__':
    ...
    eui_array_boxcar = np.load("../../src/EUI/HRI/euv174/20221024/coalign_step_boxcar/eui_map_array_boxcar_mean.npy",
                            mmap_mode="r")
    ...
    for ii, eui_map_ in enumerate(tqdm(eui_map_seq_coalign[:])):
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            f"../../figs/EUI/20221024/zoomin_hmi_boxcar/east_1/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_boxcar/west_2/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_boxcar/west_1/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_hhflare_195_velmap_derot_repro_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_boxcar/center_1/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_boxcar/east_2/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_noupflow_boxcar/region_1/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_noupflow_boxcar/region_2/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_noupflow_boxcar/region_3/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_noupflow_boxcar/region_4/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_noupflow_boxcar/region_5/eui_hmi_cutout_{ii:03}.png")
        ...
        plot_eui_hmi_cutout(eui_map_fake,hmi_map_,phi_los_map_hrifov,eis_195_velmap_derot_repro_shifted_hrifov,
                            ...
                            ImageNormalize(vmin=-1000,vmax=1000),
                            eui_map_date, hmi_map_date,
                            f"../../figs/EUI/20221024/zoomin_hmi_noupflow_boxcar/region_6/eui_hmi_cutout_{ii:03}.png")
