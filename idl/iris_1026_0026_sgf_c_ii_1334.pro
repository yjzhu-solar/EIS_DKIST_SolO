pro iris_1026_0026_sgf_c_ii_1334, wvl_shift=wvl_shift, sav=sav
    ...
    if n_elements(sav) ne 0 then begin
        ...
        chi2 = fit.chi2
        save,filename="../src/IRIS/20221026/0026/fit_res/CII_1334_raster0.sav",int,int_err,vel,vel_err,wid,wid_err,chi2,refwvl,wave_corr_fuv
    endif
end 
