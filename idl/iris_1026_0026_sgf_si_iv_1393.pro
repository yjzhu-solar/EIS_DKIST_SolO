pro iris_1026_0026_sgf_si_iv_1393, wvl_shift=wvl_shift, sav=sav

    iris_raster_file = "../src/IRIS/20221026/0026/iris_l2_20221026_002630_3600609177_raster_t000_r00000.fits"
    ...
    if n_elements(sav) ne 0 then begin
        ...
        chi2 = fit.chi2
        save,filename="../src/IRIS/20221026/0026/fit_res/SiIV_1393_raster0.sav",int,int_err,vel,vel_err,wid,wid_err,chi2,refwvl,wave_corr_fuv
    endif
