pro iris_1024_sgf_si_iv_1393, wvl_shift=wvl_shift, sav=sav
    ...
    if n_elements(sav) ne 0 then begin
        ...
        chi2 = fit.chi2
        save,filename="../src/IRIS/20221024/2322/fit_res/SiIV_1393_raster0.sav",int,int_err,vel,vel_err,wid,wid_err,chi2,refwvl,wave_corr_fuv
    endif
